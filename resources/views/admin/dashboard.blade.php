      ...
      <div class="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Accept All</a>
                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">Reject All</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- Main row -->
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">KursusMU | Platform Kuliah</h3>
